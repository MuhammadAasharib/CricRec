...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label2->Location = System::Drawing::Point(26, 101);
			...
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(163, 45);
			...
			// textBox2
			// 
			this->textBox2->Location = System::Drawing::Point(163, 98);
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(163, 153);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(75, 23);
			this->button1->TabIndex = 4;
			this->button1->Text = L"Add Admin";
			this->button1->UseVisualStyleBackColor = true;
			this->button1->Click += gcnew System::EventHandler(this, &AddAdmin::button1_Click);
			// 
			// AddAdmin
			// 
