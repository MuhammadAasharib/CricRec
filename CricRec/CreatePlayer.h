...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->listBox1->Location = System::Drawing::Point(149, 104);
			this->listBox1->Name = L"listBox1";
			this->listBox1->Size = System::Drawing::Size(100, 17);
			...
			this->label4->Text = L"Preferred Hand";
			// 
			// listBox2
			// 
			this->listBox2->FormattingEnabled = true;
			this->listBox2->Location = System::Drawing::Point(149, 135);
			this->listBox2->Name = L"listBox2";
			this->listBox2->Size = System::Drawing::Size(100, 17);
			this->listBox2->TabIndex = 7;
			// 
			// button1
			// 
			this->button1->Location = System::Drawing::Point(174, 187);
